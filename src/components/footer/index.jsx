...
export default function Footer() {
  return (
    <footer className="mx-auto mt-16 max-w-7xl rounded-[60px] bg-[#151518] p-10 text-white">
      <div className="flex flex-col justify-between gap-10 md:flex-row">
        {/* Левая часть */}
        <div className="flex flex-col justify-between">
          {/* Логотип */}
          <img src={PaxLogo} alt="" />
          <p className="mt-4 text-sm text-gray-500 md:mt-0">© PAX 2025</p>
        </div>
        ...
        <div className="flex flex-col gap-[180px] text-base sm:flex-row">
          ...
          <nva className="flex flex-col space-y-2 ">
            <NavLink to="" className="text-white">
              Сертификаты
            </NavLink>
            <NavLink to="" className="text-white">
